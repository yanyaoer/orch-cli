...
export function runCreateHelp(): string {
  return lines([
    ...
    "  --role <role>             Result role: implementer, reviewer, verifier, or controller (required)",
  ...
  switch (topic) {
    case "task-spec":
      return lines([
        ...
        "  - result.json must use the schema for its role: orch.result/implementer/v1, reviewer/v1, verifier/v1, or controller/v1.",
...
export function fanoutHelp(): string {
  return lines([
    ...
    "  --role <role>             fanout only: implementer, reviewer, verifier, or controller (required)",
