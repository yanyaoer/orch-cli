...
export function runCreateHelp(): string {
  return lines([
    ...
    "  reads/exec/network open. The controller gets only a narrow dispatch outbox",
    "  and proxies its run-create/decision/mail to an unsandboxed host reconciler",
    ...
    "  Fail-closed: non-darwin, missing provider login, a hardlinked worktree, or",
    "  a state dir symlinked outside its narrow location refuses to start the run.",
