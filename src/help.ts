...
export function runCreateHelp(): string {
  return lines([
    ...
    "  --idempotency-key <key>   Reuse an existing run for the same key; default includes mr, tag, task, and session settings",
  ...
  switch (topic) {
    ...
    case "concepts":
      return lines([
        ...
        "",
        "Provider sessions:",
        "  Defaults do not resume the most recent provider session. Claude/Codex start fresh persistent runs; Pi stays ephemeral.",
