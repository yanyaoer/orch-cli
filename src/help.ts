...
export function runCreateHelp(): string {
  return lines([
    ...
    "  worktree (.git read-only), other roles are read-only; provider state,",
    "  per-run scratch, and /private/tmp stay writable; reads/exec/network open.",
    ...
    "  Fail-closed: non-darwin, missing provider login, or a hardlinked worktree",
    "  refuses to start the run instead of silently dropping the jail.",
