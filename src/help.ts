...
export function fanoutHelp(): string {
  return lines([
    ...
    "  --clone                   Dispatch every worker against one shared APFS CoW clone of the",
    "                            worktree under /tmp/orch-clones (macOS only; reviewer/researcher",
    "                            roles only — writable roles need per-agent orch worktree clone).",
