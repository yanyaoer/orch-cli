...
export function runCreateHelp(): string {
  return lines([
    ...
    "                            omp = oh-my-pi; defaults to openai-codex/gpt-5.6-sol at xhigh thinking",
    ...
    "  at xhigh reasoning with native web search on; omp rides its default chain",
    ...
    "                            falls back to config.json defaults.agents.<role>.model",
  ...
  switch (topic) {
    case "task-spec":
      return lines([
        ...
        "    (omp = oh-my-pi: gpt-5.6-sol by default with quota fallback to claude-fable-5, then gemini-3.1-pro)",
